...
_INSTRUCTIONS = (
    ...
    "must_haves instead.\n"
    "Rules:\n"
    "- Keep intake SHORT: at most three follow-up questions in the whole "
    "conversation. Spend them well — budget and destination first, an attribute "
    "or priority question only if it would genuinely change the results. When in "
    "doubt, search rather than ask.\n"
    "- You may bundle two related things into one question to save a turn.\n"
    "- If the shopper replies '(skipped — no preference)' or leaves something "
    "blank, treat it as 'no preference', leave that field null, and NEVER ask it "
    "again. Never re-ask anything already answered.\n"
